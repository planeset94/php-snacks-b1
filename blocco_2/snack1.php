...
foreach ($ads as $ads_el) {
    // var_dump ($ads_el);

    if($ads_el['is_active']){

      $new_ads[]= array ('image_path'=> $ads_el['image_path'], 'link'=> $ads_el['link']);
    
    };

};

$percorso_immagine= $new_ads[rand(0, count($new_ads))]['image_path'];   
// echo $percorso_immagine;
